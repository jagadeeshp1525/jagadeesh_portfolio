      ...
      <div className="w-full py-10">
        <div className="container">
          <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 lg:gap-8 gap-6">
            <div className="w-full service-sec text-center mb-10 px-10">
              ...
              <h4 className="text-2xl text-black font-semibold">
                Instant account activation if instant access. Instant account
              </h4>
            </div>
            <div className="w-full service-sec text-center mb-10 px-10">
              <div className="relative service-img mb-7">
              ...
              <h2 className="text-lg font-medium mb-1 text-[#303030]">IOS</h2>
              <h4 className="text-2xl text-black font-semibold">
